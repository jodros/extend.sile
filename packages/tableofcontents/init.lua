...
function package:registerCommands()
  ...
  self:registerCommand("tableofcontents:item", function(options, content)
    if SILE.scratch.styles.frames.toc then
      SILE.call("switch-master", { id = "toc" })
    end
    ...
    SILE.settings:temporarily(function()
      ...
      SILE.call("tableofcontents:level" .. options.level .. "item", {}, _linkWrapper(options.link, function()

        SILE.call("font:toc", {}, function()
          SILE.typesetter:typeset(options.pageno .. "  ")
        end)
        
        -- SILE.call("hfill") -- ATENÇÃO
  ...
  self:registerCommand("tableofcontents:footer", function(_, _)
