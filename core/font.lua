...
SILE.settings:declare({ parameter = "font.family", type = "string or nil", default = SILE.scratch.styles.fonts.main[1] })
SILE.settings:declare({ parameter = "font.size", type = "number or integer", default = SILE.length(SILE.scratch.styles.fonts.main[2]) })
SILE.settings:declare({ parameter = "font.weight", type = "integer", default = SILE.scratch.styles.fonts.main[3] })
